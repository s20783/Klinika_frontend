    ...
    <div>
            ...
            <table className="w-full text-sm text-left text-gray-700 dark:text-gray-400">
                ...
                <tr>
                    ...
                    <th scope="col" className="px-6 uppercase text-center py-3">{t('choroba.fields.description')}</th>
                ...
                {filteredData.map(x => (
                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-600"
                        ...
                        <td scope="col" className="px-6 py-2 text-center">dfksjhndcbvsgfehdghsfifh wbf cuhebaocub efuvh uhuc uvh uweqrd gscuh evdvucdfuopdf8ygvdfe</td>
                        <td scope="col" className="px-6 py-1">
                            <div className="list-actions">
                                <div className=" flex">
                                    <Link to={`/choroby/edycjaChoroba/${x.ID_Choroba}`} className="list-actions-button-details flex-1">
                                    ...
                                    <Link to={`/choroby/delete/${x.ID_Choroba}`} className="list-actions-button-details flex-1">
