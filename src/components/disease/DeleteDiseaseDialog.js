...
import {deleteDisease} from "../../axios/DiseaseApiCalls";
import axios from "axios";
let CancelToken
let source
class DeleteDiseaseDialog extends React.Component {
    constructor(props) {
        super(props);
    ...
    removeDisease = async (idChoroba) => {
        const {navigate} = this.props;
        try {
            await deleteDisease(idChoroba, source)
    ...
    render() {
        ...
        return (
            <div className="bg-gray-200 flex items-center justify-center h-screen">
                <div
                    className="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded-lg shadow-xl z-50 overflow-y-auto">
                    <div className="modal-content py-9 px-5">
                        ...
                        <div className="flex justify-end pt-2">
                            ...
                            <button onClick={() => this.removeDisease(idChoroba)}
...
export default withTranslation()(withRouter(withNavigate(DeleteDiseaseDialog)));
