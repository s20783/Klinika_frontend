            ...
            <footer className="p-3 mt- bg-white shadow md:px-6 md:py-1 dark:bg-gray-800">
                ...
                <div className="sm:flex sm:items-end sm:justify-between mt-4 mb-2">
                    <ul className="flex flex-wrap items-center justify-center sm:justify-between mb-6 text-sm text-gray-500 sm:mb-0 dark:text-gray-400">
                        <li>
                            <Link to="" className="hover:underline hover:text-blue-400 md:mr-4 mr-2  md:ml-4 ml-2"><i className="fa-brands fa-facebook"></i>Facebook</Link>
                        </li>
                        <li>
                            <Link to="" className="hover:underline hover:text-red-400 md:mr-4 mr-2  md:ml-4 ml-2"><i className="fa-brands fa-instagram"></i>Instagram</Link>
                        </li>
                    </ul>
                    ...
                    <ul className="flex flex-wrap items-end justify-center sm:justify-between mb-6 text-sm text-gray-500 sm:mb-0 dark:text-gray-400">
                        <li>
                            <Link to="/regulamin" className="hover:underline md:mr-4 mr-2  md:ml-4 ml-2">{t('footer.regulations')}</Link>
                        </li>
                        <li>
                            <Link to="/politykaPrywatnosci" className=" hover:underline md:mr-4 mr-2  md:ml-4 ml-2">{t('footer.policy')}</Link>
                        </li>
                    </ul>
                </div>
