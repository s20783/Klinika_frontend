                        ...
                        <div className="mx-8 my-10">
                            ...
                            <form className="flex flex-col pt-5 md:pt-6" onSubmit={this.handleSubmit}>
                                <div className="my-3 pt-3  rounded bg-gray-200">
                                    <input type="text" id="Haslo" name="Haslo" placeholder="Stare hasło"
                                ...
                                <div className="my-5 pt-3 rounded bg-gray-200">
                                    <input type="password" id="NoweHaslo" name="NoweHaslo" placeholder="Nowe hasło"
                                           onChange={this.handleChange}
                                ...
                                <div className="my-3 pt-3 rounded bg-gray-200">
                                    <input type="password" id="NoweHaslo1" name="NoweHaslo1"
                                           placeholder="Potwierdź nowe hasło" onChange={this.handleChange}
