...
function LekDetailsListTable(props) {
    ...
    return (
        <>
            <p>{t('lek.name')}: <strong>{data.Nazwa} ({data.JednostkaMiary})</strong></p>
            <p>{t('choroba.title')}: {data.Choroby.map(choroba => (<strong>{choroba.Nazwa + " "}</strong>))}</p>
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                <table className="w-full text-sm text-left text-gray-700 dark:text-gray-400">
                    ...
                    <tr>
                        ...
                        <th scope="col" className="text-center px-6 py-3">{t('lek.fields.expirationDate')}</th>
                    ...
                    {list.map(lek => (
                        <tr key={lek.IdStanLeku}
                            ...
                            <td className="text-center text-center px-6 py-1">
            ...
            <div className=" md:flex mb-6 mt-8 ">
                ...
                <button type="submit"
                    ...
                    {t('lek.button.addMedicineInWarehouse')}
                </button>
            </div>
        </>
    )
