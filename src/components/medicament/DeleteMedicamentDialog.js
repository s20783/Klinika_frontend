...
import {deleteMedicament} from "../../axios/MedicamentApiCalls";
...
class DeleteMedicamentDialog extends React.Component {
    constructor(props) {
        super(props);
    ...
    removeLek = async (idLek) => {
        ...
        try {
            await deleteMedicament(idLek, source)
            ...
            <div className="bg-gray-200 flex items-center justify-center h-screen">
                <div
                    ...
                    <div className="modal-content py-9 px-5">
                        <p className="text-4xl mb-2 text-center font-bold">{t('lek.deletingMedicine')}</p>
                        ...
                        <div className="flex justify-end pt-2">
                            ...
                            <button onClick={() => this.removeLek(idLek)}
                                    className="shadow-xl px-4 bg-blue-400 p-3 rounded-lg text-white hover:bg-blue-400">{t('lek.deleteMedicine')}</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default withTranslation()(withRouter(withNavigate(DeleteMedicamentDialog)));