                ...
                <div className="w-full flex flex-wrap">
                    <div className="bg-white  max-w-lg mx-auto  md:p-3 my-4 rounded-lg shadow-2xl">
                        <div className=" mx-6">
                            ...
                            <form className="flex flex-col pt-5 md:pt-4">
                                <div className=" py-2">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="my-3 pt-3  rounded bg-gray-200">
                                        <input type="text" name="Imie" id="Imie" placeholder="Imię *" onChange={this.handleChange}
                                               className="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-blue-400 transition duration-500 py-2 px-3"/>
                                    </div>
