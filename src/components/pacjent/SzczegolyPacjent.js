...
class SzczegolyPacjent extends React.Component {
    ...
    render() {
        const {error, isLoaded, pacjent, wizyty} = this.state
        const {t} = this.props;
        let content;
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6 border-b">
                            ...
                            <div class="w-full md:w-2/6 px-3 ml-8">
                                ...
                                <input
                                    ...
                                    name="Rasa" id="Rasa" type="text" value={pacjent.Rasa} placeholder=""
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6 border-b">
                            ...
                            <div class="w-full md:w-1/3 px-3 mb-6 ml-8 md:mb-0">
                                ...
                                <input
                                    ...
                                    name="Masc" id="Masc" type="text" value={pacjent.Masc} placeholder=""
                                    onChange={this.handleChange}/>
                            </div>
                        </div>
                        <div class="flex flex-wrap -mx-3 mb-6 border-b">
