...
import {deletePacjent} from "../../axios/PacjentAxiosCalls";
    ...
    render() {
        ...
        return (
            <div class="bg-gray-200 flex items-center justify-center h-screen">
                <div
                    class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded-lg shadow-xl z-50 overflow-y-auto">
                    <div class="modal-content py-9 px-5">
                        ...
                        <div class="flex justify-end pt-2">
                            <button onClick={() => navigate(-1)}
                                    class="shadow-xl px-4 bg-transparent p-3 rounded-lg text-blue-400 hover:bg-gray-100 hover:text-blue-400 mr-2">
                                {t('button.back')}
                            </button>
