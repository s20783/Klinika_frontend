...
let CancelToken
let source
class DeleteSpecializationDialog extends React.Component {
    constructor(props) {
        super(props);
            ...
            <div className="bg-gray-200 flex items-center justify-center h-screen">
                <div
                    ...
                    <div className="modal-content py-9 px-5">
                        <p className="text-4xl mb-2 text-center font-bold">{t('specjalizacja.deletingSpecialization')}</p>
                        ...
                        <div className="flex justify-end pt-2">
                            ...
                            <button onClick={() => this.removeSpecjalizacja(idSpecjalizacja)}
                                    className="shadow-xl px-4 bg-blue-400 p-3 rounded-lg text-white hover:bg-blue-400">{t('specjalizacja.deleteSpecialization')}</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default withTranslation()(withRouter(withNavigate(DeleteSpecializationDialog)));
