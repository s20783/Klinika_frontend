...
class SpecializationList extends React.Component {
    ...
    render() {
        ...
        if (error) {
            ...
            content = <SpecializationListTable specjalizacje={data} getData={this.getData} pageCount={pageCount}/>
        }
...
export default withTranslation()(withNavigate(SpecializationList));