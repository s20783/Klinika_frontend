        ...
        <div>
            ...
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg ">
                ...
                <table className="w-full text-sm text-left text-gray-700 dark:text-gray-400">
                    ...
                    <tr>
                        <th scope="col"
                            className="text-center px-6 uppercase py-3">{t('specjalizacja.fields.name')}</th>
                        <th scope="col"
                            className="text-center px-6 uppercase py-3">{t('specjalizacja.fields.description')}</th>
