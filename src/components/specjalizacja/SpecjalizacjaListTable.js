                ...
                <div className="relative mt-1">
                    ...
                    <label htmlFor="search">
                        ...
                        <Link to="/dodajSpecjalizacje"
                            ...
                            <span className="text-xl">+</span> {t('specjalizacja.button.addSpecialization')}
                        </Link>
                    </label>
                </div>
            </div>
                    ...
                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-600"
                        ...
                        <td scope="col" className="px-6 py-1">
                            <div className="list-actions">
                                <div className=" flex">
                                    <Link to={`/specjalizacje/edycjaSpecjalizacja/${x.IdSpecjalizacja}`} className="list-actions-button-details flex-1">
                                    ...
                                    <Link to={`/specjalizacje/delete/${x.IdSpecjalizacja}`} className="list-actions-button-details flex-1">
