            ...
            <div className="overflow-x-auto shadow-xl sm:rounded-lg">
                <table className="w-full text-xs sm:text-sm md:text-base text-left text-gray-700 dark:text-gray-400">
                    ...
                    <tr>
                        ...
                        <th scope="col"
                            className="text-center px-1 md:px-6 py-3">{t('szczepionka.fields.application')}</th>
                        <th scope="col"
                            className="text-center px-1 md:px-6 py-3">{t('szczepionka.fields.mandatory')}</th>
                        <th scope="col"
                            className="text-center px-1 md:px-6 py-3">{t('szczepionka.fields.periodOfValidity')}</th>
