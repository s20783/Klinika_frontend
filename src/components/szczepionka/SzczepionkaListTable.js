            ...
            <div className="p-4 ">
                <div className="relative mt-1 ">
                    ...
                    <Link to="/dodajSzczepionke"
                          className="absolute    top-0 right-0  h-12 w-12 sm:w-52  shadow bg-blue-400 hover:bg-white  hover:text-blue-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded">
            ...
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg ">
                ...
                <table className="w-full text-sm text-left text-gray-700 dark:text-gray-400">
                    ...
                    <tr>
                        ...
                        <th scope="col"
                            className="text-center px-6 uppercase py-3">Producent</th>
                    ...
                    {filteredData.map(x => (
                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-600"
                            ...
                            <td className="text-center px-6 py-2">{x.Zastosowanie}</td>
                            <td className="text-center px-6 py-2">{x.CzyObowiazkowa ? t("other.yes") : t("other.no")}</td>
                            <td className="text-center px-6 py-2">{x.OkresWaznosci}</td>
                            <td className="text-center px-6 py-2">{x.Producent ? x.Producent : "-" }</td>
