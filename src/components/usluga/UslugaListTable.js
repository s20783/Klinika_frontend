        ...
        <>
            ...
            <div className="overflow-x-auto shadow-xl sm:rounded-lg">
                <table className="w-full text-xs sm:text-sm md:text-base text-left text-gray-700 dark:text-gray-400">
                    ...
                    <tr>
                        <th scope="col" className="text-center px-1 md:px-6 py-3">{t('usluga.fields.name')}</th>
                        <th scope="col" className="text-center px-1 md:px-6 py-3">{t('usluga.fields.description')}</th>
                    ...
                    {filteredData.map(x => (
                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-600"
                            key={x.ID_usluga}>
                            <td className="text-center px-1 md:px-6 py-2">{x.NazwaUslugi} </td>
                            <td className="text-center px-1 md:px-6 py-2">{x.Opis}</td>
                            <td className="text-center px-1 md:px-6 py-2">{x.Dolegliwosc}</td>
                            <td className="text-center px-1 md:px-6 py-2">{x.Narkoza ? t("other.yes") : t("other.no")}</td>
                            <td className="text-center px-1 md:px-6 py-2">{x.Cena}</td>
