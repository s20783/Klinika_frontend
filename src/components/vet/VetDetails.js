                ...
                <div
                    ...
                    <div className="flex flex-wrap -mx-3 mb-6 border-b">
                        <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            ...
                            <input
                                className="shadow-xl form-textarea block w-full text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight bg-gray-50"
                        ...
                        <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0 md:ml-8">
                            ...
                            <input
                                className="shadow-xl appearance-none form-textarea block w-full text-gray-700 border border-gray-200 rounded py-3 px-4 mb-6 leading-tight bg-gray-50"
                    ...
                    <div className="flex flex-wrap -mx-3 mb-6  ">
                        <div className="w-full md:w-1/3 px-3 mb-6  md:mb-0">
                            ...
                            <input
                                className="shadow-xl appearance-none form-textarea block w-full text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight bg-gray-50"
...
export default withTranslation()(withNavigate(withRouter(VetDetails)));