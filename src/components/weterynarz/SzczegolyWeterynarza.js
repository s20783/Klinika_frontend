...
import {getWeterynarzSpecjalizacjaList, addWeterynarzSpecjalizacja, deleteWeterynarzSpecjalizacja } from "../../api/WeterynarzSpecjalizacjaApiCalls";
        ...
        <div class="container w-full flex flex-wrap mx-auto px-2 pt-8 lg:pt-3 mt-3">
                ...
                className="w-full lg:w-5/6 p-8 mt-6 lg:mt-0 text-gray-900 leading-normal bg-white border border-gray-400 border-rounded">
                    <section class="bg-white-100 border-b  mb-7">
                        <div class=" flex flex-wrap md:flex mb-6 mt-4">
                            ...
                            <div class="md:w-3/5">
                                 ...
                                 name="Login" id="Login" type="text" value={this.state.data.Login}  placeholder="" />
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6  ">
                          ...
                          <div class="w-full md:w-1/3 px-3 mb-6  md:mb-0">
                               ...
                               <input class="appearance-none form-textarea block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                     name="DataZatrudnienia" id="DataZatrudnienia" type="text" value={dayjs(this.state.data.DataZatrudnienia).format('YYYY-MM-DD')} placeholder=""/>
                          </div>
                    </div>
            ...
            <table className="w-full text-sm text-left text-gray-700 dark:text-gray-400">
                ...
                <tr>
                    ...
                    <th scope="col" className="px-6 uppercase py-3">{t('specjalizacja.fields.description')}</th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
                {this.state.specjalizacje.map(x => (
                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-600"
                        ...
                        <td scope="col" className="px-6 py-2">{x.Opis}</td>
                            <div className="list-actions py-2">
                                <div className=" flex">
                                    <button onClick={() => { this.deleteSpec(x.IdSpecjalizacja)}} className="list-actions-button-details flex-1">
                               ...
                               <div class="md:w-full">
                                   <select name="IdSpecjalizacja" id="spec-content" onChange={this.handleChange}
                                        ...
                                        <option value="">Wybierz specjalizacje</option>
                                        {
                                            ...
                                            <option  value={spec.IdSpecjalizacja}>{spec.IdSpecjalizacja} {spec.Nazwa} - {spec.Opis}  </option>
                                        ))}
                                   </select>
                                    <span id="errorIdSpecjalizacja" name="IdSpecjalizacja" className="errors-text2 mt-4">{this.state.errors.IdSpecjalizacja}</span>
                                     <div className="relative  w-full ">
                                      <button id="spec-content1" onClick={() => { this.addSpec()}}
