...
class CreateWorkingHoursDialog extends React.Component {
    constructor(props) {
        super(props);
                    ...
                    <div className="modal-content py-9 px-5">
                        ...
                        <div className="flex justify-end pt-2">
                            ...
                            <Link to={`/godzinyPracy/${idWeterynarz}`}>
                                <button
                                    className="shadow-lg px-4 bg-blue-400 p-3 rounded-lg text-white hover:bg-blue-400">{t('godzinyPracy.addWorkingHour')}</button>
                            </Link>
                        </div>
                    </div>
                </div>
...
export default withTranslation()(withRouter(withNavigate(CreateWorkingHoursDialog)));